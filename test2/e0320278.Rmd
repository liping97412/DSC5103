...
#### Q1b. Now suppose your task is to predict the future sales of **new products** that (1) are with new *prod_id*; and (2) still belong to one of the existing *prod_function* and also *prod_regmie*, write down the supervised learning model with all reasonable predictors.  (3 points)
...
formula_1b <- as.formula(sales~weekend+holiday+prod_function+prod_regime+prod_listprice)
...
formula_1c <- as.formula(sales~weekend+holiday+prod_function+prod_listprice)
